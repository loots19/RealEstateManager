...
data class Property(
        ...
        @ColumnInfo(name = "agent_mail") var agentMail: String = ""
       // @ColumnInfo(name = "photo_list") var photoList : List<Photo>
    ...
    companion object {
        fun fromContentValues(values: ContentValues): Property {
            ...
            if (values.containsKey("agent_mail")) property.agentMail = values.getAsString("agent_mail")
            // if(values.containsKey("photo_list"))property.photoList = values.valueSet("photo_list")
